# Source: https://discord.com/channels/566880874789076992/1306602404401250374/1319268082719391835
# Within KivyMD discord server
# (I hate discord being not searchable with better tools as this was somewhat hard to find)
...
mx_path = os.path.dirname(__file__)

with open(
    os.path.join(mx_path, "datatables.kv"), encoding="utf-8"
) as kv_file:
...
class TablePagination(MDBoxLayout, ThemableBehavior):
    ...
    def add_row(self, data: Union[list, tuple]) -> None:
        ...
        .. code-block:: python
            ...
            class Example(MDApp):
                ...
                def on_button_press(self, instance_button: MDButton) -> None:
